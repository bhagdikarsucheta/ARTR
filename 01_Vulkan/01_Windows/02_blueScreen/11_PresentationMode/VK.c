...
VkResult Initialize(void)
{
	...
	if (vkResult != VK_SUCCESS)
	{
		...
		fprintf(gpFile, "Initialize()->getSupportedSurface Function is Succeded\n");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "Initialize()->printVKInfo Function is Failed %d\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gpFile, "Initialize()->printVKInfo Function is Succeded\n");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "Initialize()->createVulkanDevice Function is %d\n", vkResult);
		return vkResult;
	}
	else {
		fprintf(gpFile, "Initialize()->createVulkanDevice Function is Succeded");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "Initialize()->getPhysicalDeviceSurfaceFormatAndColorSpace Function is %d\n", vkResult);
		return vkResult;
	}
	else {
		fprintf(gpFile, "Initialize()->getPhysicalDeviceSurfaceFormatAndColorSpace Function is Succeded");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "Initialize()->getPhysicalDevicePresentMode Function is %d\n", vkResult);
		return vkResult;
	}
	else {
		fprintf(gpFile, "Initialize()->getPhysicalDevicePresentMode Function is Succeded");
	}
