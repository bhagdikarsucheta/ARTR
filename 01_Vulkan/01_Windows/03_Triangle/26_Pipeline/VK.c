...
VkResult createPipeline(void)
{
	...
	vkVertexInputBindingDescription_array[0].inputRate = VK_VERTEX_INPUT_RATE_VERTEX; //(dx11 ->D3D11_INPUT_ELEMENT_DESC ->I	fflush(gpFile);
	////
	...
	//Binding will chage during interleaved else both of above binding will be same
